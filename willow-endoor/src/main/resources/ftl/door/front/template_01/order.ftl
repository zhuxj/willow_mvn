...
<#else>
    ...
    <script src="${resourceRoot}/door/front/js/template_01/order.js" type="text/javascript"></script>
</head>
<body>
<div id="wrapper">
    <!--head start-->
                                ...
                                <div class="commentbox">
                                    <form id="form1" name="form1" method="post" action="/order/createOrder">
                                        ...
                                        <table id="commentform" width="600" border="0" align="center" cellpadding="0"
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="FontRed">*</span>&nbsp;${customDirectives.getMessage("订购产品","Product")}</td>
                                                <td>
                                                    <span class="OrderName">
                                                    <select id="productCat">
                                                        <option value="">${customDirectives.getMessage("请选择","select")}</option>
                                                    <#list productCatalogs as productCatalog>
                                                        <option value="${productCatalog.objId}">${customDirectives.getMessage(productCatalog.catalogName!,productCatalog.catalogNameEn!)}</option>
                                                    </#list>
                                                    </select>
                                            ...
                                            <tr>
                                                <td><span class="FontRed">*</span>&nbsp;${customDirectives.getMessage("订购数量","Count")}
                                                </td>
                                            ...
                                            <tr>
                                                <td><span
                                                        class="FontRed">*</span>&nbsp;${customDirectives.getMessage("联系人","Your name")}
                                                </td>
                                            ...
                                            <tr>
                                                <td><span
                                                        class="FontRed">*</span>&nbsp;${customDirectives.getMessage("联系地址","Your address")}
                                                </td>
                                            ...
                                            <tr>
                                                <td><span
                                                        class="FontRed">*</span>&nbsp;${customDirectives.getMessage("联系手机","Your phone")}
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    &nbsp;&nbsp;&nbsp;${customDirectives.getMessage("联系电话","Your tel")}</td>
                                                <td><input name="contactTel" type="text" id="contactTel" size="30"
                                                           maxlength="30"></td>
                                            </tr>
                                            <tr>
                                                <td><span
                                                        class="FontRed">*</span>&nbsp;${customDirectives.getMessage("电子邮件","Your Email")}
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    &nbsp;&nbsp;&nbsp;${customDirectives.getMessage("验证码","Verify code")}</td>
