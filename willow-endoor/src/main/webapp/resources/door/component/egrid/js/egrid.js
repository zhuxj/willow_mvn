(function ($) {
    ...
    DataProvider.prototype.load = function () {
        ...
        if (this.grid.opt.sorts) {
            if (this.grid.opt.sorts.sortFieldName) {
                this.params.sortFieldName=this.grid.opt.sorts.sortFieldName;
            }
            if (this.grid.opt.sorts.sortType) {
                this.params.sortType=this.grid.opt.sorts.sortType;
            }
        }
