...
<head>
    <title>增加文件信息</title>
    <script type="text/javascript" src="${resourceRoot}/door/admin/js/doorfile/add.js"></script>
</head>
<body>
<form id="doorFileForm">
    <input type="hidden" class="ipt_250" name="fileId" id="fileId">
    <input type="hidden" class="ipt_250" name="fileType" id="fileType">
    <input type="hidden" class="ipt_250" name="fileSize" id="fileSize">
    <input type="hidden" class="ipt_250" name="fileIdEn" id="fileIdEn">
    <input type="hidden" class="ipt_250" name="fileTypeEn" id="fileTypeEn">
    <input type="hidden" class="ipt_250" name="fileSizeEn" id="fileSizeEn">
    ...
    <div class="formlist">
        <table>
            ...
            <tr>
                <th width="150">
                    <em class="fstar">*</em>中文文件名称：
                </th>
                <td>
                    <input class="ipt_250" name="fileName" id="fileName">
            ...
            <tr>
                <th width="150">
                    <em class="fstar">*</em>英文文件名称：
                </th>
                <td>
                    <input class="ipt_250" name="fileNameEn" id="fileNameEn">
                ...
                <td>
                    <select class="ipt_250" name="catalogId" id="catalogId">
                        <c:forEach var="cat" items="${fileCatalogs}">
                            <option value="${cat.objId}">${cat.catalogName}</option>
                        </c:forEach>
                    </select>
            ...
            <tr>
                <th></th>
                <td>
                    <span class="btn btn01" id="saveDoorFile"><a href="javascript:void(0)"><b>保存</b></a></span>
