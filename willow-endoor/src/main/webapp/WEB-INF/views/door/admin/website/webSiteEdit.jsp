...
<div id="conheight">
    <div class="formlist">
        ...
        <table>
            ...
            <tr>
                <th><em class="fstar">*</em>网站logo：</th>
                <td>
                    <div>
                        <div class="btn_upload iconbg">
                            <input size="2" id="logoImageFile" type="file" name="logoImageFile" onchange="uploadBrandImage();"/>
                            <input id="logoImageId" style="display:none;" name="logoImageId" value="${webSite.logoImageId}"/>
                        </div>
                        <span class="fgray7 fl"> 图片的最佳高度60px</span>
                        <div id="divLogoImage" class="brandlogo mart_10"><img height="60px" width="160px" id="logoImage" src="/image/${webSite.logoImageId}.jpg"/></div>
                </td>
            </tr>
            ...
            <tr>
                <th>第三方客服：</th>
                <td>
                    <textarea rows="5" cols="100" name="serviceInfo" id="serviceInfo">
                        ${webSite.serviceInfo}
                    </textarea>
                </td>
            </tr>
