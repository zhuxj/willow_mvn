...
<head>
    <title>更新幻灯片</title>
    <script type="text/javascript" src="${resourceRoot}/door/admin/js/doorslide/update.js"></script>
</head>
<body>
    ...
    <div class="formlist">
        <table>
            ...
            <tr>
                <th></th>
                <td>
                    <span class="btn btn01" id="updateDoorSlide"><a href="javascript:void(0)"><b>保存</b></a></span>
