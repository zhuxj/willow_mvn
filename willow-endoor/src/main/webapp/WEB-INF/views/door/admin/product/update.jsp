...
<form id="productForm">
    ...
    <input type="hidden" class="ipt_250" name="productImage" id="productImage" value="${product.productImage}">
    <input type="hidden" class="ipt_250" name="browseTime" id="browseTime"  value="${product.browseTime}">
    <div class="formlist">
        <table>
            <tbody>
                <tr>
