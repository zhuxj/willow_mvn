...
<head>
    <title>增加订单信息</title>
    <script type="text/javascript" src="${resourceRoot}/door/admin/js/filecatalog/add.js"></script>
</head>
<body>
    ...
    <div class="formlist">
        <table>
            ...
            <tr>
                <th></th>
                <td>
                    <span class="btn btn01" id="saveFileCatalog"><a href="javascript:void(0)"><b>保存</b></a></span>
