...
*/
@Controller
@RequestMapping(WebSiteContext.MANAGER + "admin/dooroem")
public class DoorOemController extends BaseController {
@Autowired
private DoorArticleService doorArticleService;
    ...
    public ModelAndView listPage(DoorArticle doorArticle) {
        ...
        doorArticle.setArticleType(DoorArticle.ARTICLETYPE_OEM);
