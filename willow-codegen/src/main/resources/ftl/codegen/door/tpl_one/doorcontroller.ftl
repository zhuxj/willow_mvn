...
*/
@Controller
@RequestMapping(WebSiteContext.MANAGER + "${codeGenConfig.codeGenFileConfig.pageType}/${codeGenConfig.table.simplePackageVar!}")
public class ${codeGenConfig.table.classVar!}Controller extends BaseController {
    ...
    public ModelAndView addPage(${codeGenConfig.table.classVar!} ${codeGenConfig.table.classVariable!}) {
        ModelAndView view = new ModelAndView("${codeGenConfig.codeGenFileConfig.jspDir!}/${codeGenConfig.table.simplePackageVar!}add");
        return view;
    }
    ...
    public ModelAndView updatePage(${codeGenConfig.table.classVar!} ${codeGenConfig.table.classVariable!}) {
        ModelAndView view = new ModelAndView("${codeGenConfig.codeGenFileConfig.jspDir!}/${codeGenConfig.table.simplePackageVar!}update");
    ...
    public ModelAndView listPage(${codeGenConfig.table.classVar!} ${codeGenConfig.table.classVariable!}) {
        ModelAndView view = new ModelAndView("${codeGenConfig.codeGenFileConfig.jspDir!}/${codeGenConfig.table.simplePackageVar!}list");
        return view;
    }
    ...
    */
    ...
    public ModelAndView detailPage(String objId) {
        ModelAndView view = new ModelAndView("${codeGenConfig.codeGenFileConfig.jspDir!}/${codeGenConfig.table.simplePackageVar!}detail");
