...
public class CustomDirectives implements ApplicationContextAware {
    ...
    public String getMessage(String val, String valEn) {
        if (getIsEnglish()) {
            return valEn;
        }
        return val;
    ...
    public String formartTime(String time) {
        return DateUtils.toDisplayStr(time, DateUtils.HYPHEN_DISPLAY_DATE);
    }


    public String formartDate(String time) {
        return DateUtils.getDateFormat(time, "yyyyMMddHHmmss");
    }
